...
- **Phase 1 (Front-end shell) is IN PROGRESS.** Full plan: `phase-1-plan.md` (15 steps). Roadmap pointer: `phases.md`.
  ...
  - **Not started:** Steps 8–15 (the 6 panel views — chat/activity/approvals/tasks/memory/skills+settings — plus voice presence and the phase E2E pass). **Step 8 (chat view) is next.**
