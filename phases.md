...
- **Phase 0 is done** (skeleton + IPC contract, hardened with hello_ack/queueing) — see [phase-0-plan.md](phase-0-plan.md). **Phase 1 is done** — see [phase-1-plan.md](phase-1-plan.md). **Phase 2 is planned**: [phase-2-plan.md](phase-2-plan.md).
